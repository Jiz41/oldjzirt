...
function displayRandomMaxim() {
    ...
    const maxims = [
        ...
        { maxim: "幸運と勇気を！", speaker: "ブラフォード" },  // 元の "LUCK(幸運を)&PLUCK(勇気をッ!)" を訳に統一
        ...
        // 追加分（後から入れたもの、ケンさんがOKしたので残す）
        { maxim: "ギャンブルは自分との闘い。冷静に自分を客観視できる精神力が必要とされますから", speaker: "秋元康" },
        { maxim: "勝負は強いから勝つのではない。９９％の人は自滅することで結果として相手を勝たせてしまうのだ", speaker: "桜井章一" },
        { maxim: "賭けない男たち、というのは魅力のない男たちである。彼らは、つねに『選ぶ』ことを恐れる", speaker: "寺山修司" },
        { maxim: "博打で負けに負けて最後に起死回生を狙って厚く張ったコマが当たった例があるか？", speaker: "福本伸行" },
        { maxim: "勝者と敗者の違いは、ただ性格だけだ", speaker: "ニック・ザ・グリーク（ニック・ダンドロス）" },
        { maxim: "ギャンブルは、絶対使っちゃいけない金に手を付けてからが本当の勝負だ", speaker: "菊池寛" },
        { maxim: "麻雀は人生の縮図のようなもの", speaker: "藤田晋" },
        { maxim: "博打なんてチョコレート。夢見てる時は甘いけど消える。でも男は時々甘いものが欲しいんだよ", speaker: "吉田敬" },
        { maxim: "最初に損するのがいいのです。勝てば自分の腕と思いこむ", speaker: "岩本巌" },
        { maxim: "ギャンブルは知的な戦いだ", speaker: "村上龍" },
        { maxim: "ハウスはプレイヤーに勝つわけではない。ただ、彼自身に勝つ機会を与えているだけだ", speaker: "ニック・ザ・グリーク（ニック・ダンドロス）" }
    ];
