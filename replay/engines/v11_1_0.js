...
function getScenarioCoeffs(scenario) {
    if (scenario === '先行有利') return { '逃': 1.05, '自': 1.03, '追': 1.00 };
    if (scenario === '捲り有利') return { '逃': 1.00, '自': 1.08, '追': 1.03 };
    if (scenario === '差し有利') return { '逃': 1.00, '自': 0.97, '追': 1.06 };
